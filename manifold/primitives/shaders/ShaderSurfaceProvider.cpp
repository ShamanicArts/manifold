...
int readBlendModeValue(const juce::var& blendVar) {
...
bool parsePassConfig(const juce::var& passVar, ParsedPassConfig& pass, std::string& errorOut) {
...
bool parseSourceConfig(const juce::var& sourceVar, ParsedSourceConfig& source, std::string& errorOut) {
...
std::string buildDescriptorSignature(const std::string& surfaceType,
