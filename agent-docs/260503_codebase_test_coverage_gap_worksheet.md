...
| ✅ **P1** | Lua bindings behavior (21 files) | DONE — 10 binding families under deterministic contract (Command, DSP, Graph, OSC, UI/Canvas, Event, Utility, Waveform, MIDI, Link). MIDI bindings use dynamic_cast for test-safe null path. Golden verification with clearAttachedUiLuaState teardown. |
