...
function buildPlugin(ctx)
  return MidiEffectScaffold.buildMidiEffect(ctx, {
    description = "Manifold Velocity Mapper",
    schemaSpecId = "velocity_mapper",
    slotIndex = 1,
    instanceNodeId = "standalone_velocity_mapper_1",
    voiceCount = 8,
    adapterRequire = "export_midi_effects.velocity_mapper",
    viewStateKey = "__midiSynthVelocityMapperViewState",
  })
end
