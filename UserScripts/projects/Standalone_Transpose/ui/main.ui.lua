...
return ExportPluginShell.build({
  rootId = "standalone_transpose_root",
  title = "Transpose",
  accent = 0xff22c55e,
  width = 236,
  height = 176,
  ...
  contentWidth = 236,
  contentHeight = 164,
  moduleId = "transpose_component",
  moduleBehavior = "../Main/ui/behaviors/transpose.lua",
  moduleRef = "../Main/ui/components/transpose.ui.lua",
  moduleProps = {
