...
return {
  ...
  children = {
    ...
    -- Left visual area: XY / filter graph
    { id = "xy_pad", type = "Panel", x = 10, y = 10, w = 216, h = 188, style = { bg = 0xff0d1420, border = 0xff1a1a3a, borderWidth = 1, radius = 6 } },
    { id = "filter_graph", type = "Panel", x = 10, y = 10, w = 216, h = 188, props = { visible = false }, style = { bg = 0xff0d1420, border = 0xff1a1a3a, borderWidth = 1, radius = 6 } },
