return {
  ...
  children = {
    ...
    { id = "blendAmount_slider", type = "Slider", x = 12, y = 82, w = 248, h = 20, props = { min = 0, max = 1, step = 0.01, value = 0.5, label = "Blend", compact = true, bidirectional = true, showValue = true }, style = { colour = 0xffff9a62, bg = 0xff261913, fontSize = 9 } },
    { id = "blendModAmount_slider", type = "Slider", x = 12, y = 108, w = 248, h = 20, props = { min = 0, max = 1, step = 0.01, value = 0.5, label = "Depth", compact = true, showValue = true }, style = { colour = 0xfffb7185, bg = 0xff2d1517, fontSize = 9 } },
