...
local function railSocket(id, x, y, accent, side)
  local bezel = accent or 0xfffb7185
  local glow = 0x20fb7185
  return {
    id = id,
    type = "Panel",
    x = x, y = y, w = 14, h = 14,
...
return {
  ...
  children = {
    ...
    -- Top-left audio receive stays absent; MIDI gets its own blue ingress.
    railSocket("leftMidiIn", 6, 128, 0xff38bdf8, "left"),
    ...
    railSocket("leftRailRecv2", 6, 348, 0xfffb7185, "left"),
    railSocket("leftRailRecv3", 6, 568, 0xfffb7185, "left"),
    {
      id = "rackRow1",
      type = "Panel",
    ...
    },
    {
      ...
      children = {
        ...
        RackModuleShell({
          ...
          componentBehavior = "ui/behaviors/source_panel.lua",
          componentOverrides = {
            oscillatorComponent = {
              style = { bg = 0x00000000, border = 0x00000000, borderWidth = 0, radius = 0 },
              props = { interceptsMouse = false },
