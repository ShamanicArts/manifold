return {
  ...
  children = {
    -- Legacy hidden widgets retained for behavior/state updates.
    ...
    -- Keyboard Section background first, so header controls below render on top of it.
    { id = "keyboardPanel", type = "Panel", x = 0, y = 0, w = 0, h = 0, style = { bg = 0xff11172a, border = 0xff1f2b4d, borderWidth = 1, radius = 10 } },

    -- Keyboard header / MidiSynth controls.
    ...
    { id = "keyboardCollapse", type = "Button", x = 0, y = 0, w = 28, h = 24, props = { label = "▼" }, style = { bg = 0xff1e293b, fontSize = 12 } },
    ...
    { id = "resetPreset", type = "Button", x = 0, y = 0, w = 80, h = 22, props = { label = "Reset" }, style = { bg = 0xff7f1d1d, fontSize = 10 } },
    { id = "keyboardStatusPrimary", type = "Label", x = 0, y = 0, w = 0, h = 0, props = { text = "MIDI waiting · Input: None" }, style = { colour = 0xffcbd5e1, fontSize = 11 } },
    { id = "keyboardStatusSecondary", type = "Label", x = 0, y = 0, w = 0, h = 0, props = { text = "Voices: idle · No MIDI yet" }, style = { colour = 0xff94a3b8, fontSize = 10 } },
    -- Voice note labels (color-coded per voice, matches ADSR/oscillator colors)
    { id = "voiceNote1", type = "Label", x = 0, y = 0, w = 0, h = 0, props = { text = "" }, style = { colour = 0xff4ade80, fontSize = 12 } },
    { id = "voiceNote2", type = "Label", x = 0, y = 0, w = 0, h = 0, props = { text = "" }, style = { colour = 0xff38bdf8, fontSize = 12 } },
    { id = "voiceNote3", type = "Label", x = 0, y = 0, w = 0, h = 0, props = { text = "" }, style = { colour = 0xfffbbf24, fontSize = 12 } },
    { id = "voiceNote4", type = "Label", x = 0, y = 0, w = 0, h = 0, props = { text = "" }, style = { colour = 0xfff87171, fontSize = 12 } },
    { id = "voiceNote5", type = "Label", x = 0, y = 0, w = 0, h = 0, props = { text = "" }, style = { colour = 0xffa78bfa, fontSize = 12 } },
    { id = "voiceNote6", type = "Label", x = 0, y = 0, w = 0, h = 0, props = { text = "" }, style = { colour = 0xff2dd4bf, fontSize = 12 } },
    { id = "voiceNote7", type = "Label", x = 0, y = 0, w = 0, h = 0, props = { text = "" }, style = { colour = 0xfffb923c, fontSize = 12 } },
    { id = "voiceNote8", type = "Label", x = 0, y = 0, w = 0, h = 0, props = { text = "" }, style = { colour = 0xfff472b6, fontSize = 12 } },
    ...
    { id = "keyboardCanvas", type = "Panel", x = 0, y = 0, w = 0, h = 0, style = { bg = 0xff0d1420, radius = 6 } },
