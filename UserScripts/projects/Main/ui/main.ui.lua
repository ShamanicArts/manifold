  ...
  components = {
    {
      ...
      w = 1280,
      h = 46,
      layout = { mode = "hybrid", left = 0, top = 0, right = 0 },
      behavior = "ui/behaviors/shared_transport.lua",
      ref = "ui/components/shared_transport.ui.lua",
    },
    {
      id = "global_capture_plane",
      x = 0,
      y = 52,
      w = 1280,
      h = 124,
      layout = { mode = "hybrid", left = 0, top = 52, right = 0 },
  ...
  children = {
    {
      ...
      w = 1280,
      h = 538,
      layout = { mode = "hybrid", left = 0, top = 182, right = 0, bottom = 0 },
      props = {
        activeIndex = 1,
        tabBarHeight = 34,
        tabSizing = "fill",
