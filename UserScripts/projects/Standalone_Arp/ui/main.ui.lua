...
return ExportPluginShell.build({
  ...
  contentWidth = 236,
  contentHeight = 164,
  moduleId = "arp_component",
  moduleBehavior = "../Main/ui/behaviors/arp.lua",
  moduleRef = "../Main/ui/components/arp.ui.lua",
  moduleProps = {
    instanceNodeId = "standalone_arp_1",
