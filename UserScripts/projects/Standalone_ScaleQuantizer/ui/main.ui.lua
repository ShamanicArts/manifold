...
return ExportPluginShell.build({
  rootId = "standalone_scale_quantizer_root",
  ...
  contentWidth = 236,
  contentHeight = 164,
  moduleId = "scale_quantizer_component",
  moduleBehavior = "../Main/ui/behaviors/scale_quantizer.lua",
  moduleRef = "../Main/ui/components/scale_quantizer.ui.lua",
  moduleProps = {
    instanceNodeId = "standalone_scale_quantizer_1",
