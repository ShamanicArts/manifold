...
function buildPlugin(ctx)
  return MidiEffectScaffold.buildMidiEffect(ctx, {
    description = "Manifold Scale Quantizer",
    schemaSpecId = "scale_quantizer",
    slotIndex = 1,
    instanceNodeId = "standalone_scale_quantizer_1",
    voiceCount = 8,
    adapterRequire = "export_midi_effects.scale_quantizer",
    viewStateKey = "__midiSynthScaleQuantizerViewState",
  })
end
