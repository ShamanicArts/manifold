...
return ExportPluginShell.build({
  ...
  contentWidth = 472,
  contentHeight = 208,
  moduleId = "sample_component",
  moduleBehavior = "ui/behaviors/standalone_sample.lua",
  moduleRef = "ui/components/standalone_sample.ui.lua",
  moduleProps = {
    instanceNodeId = "standalone_sample_1",
