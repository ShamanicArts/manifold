-- Project-local LooperTabs Super FX extension.
--
-- This module owns the shared Super graph for the LooperTabs project. It is
-- reused both by the standalone SuperDonut path and by the LooperTabs shared
...
local function attach(ctx, layers)
  ...
  ctx.graph.connect(state.vocal.output, mainMixer, 0, 1)
