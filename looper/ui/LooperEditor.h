...
private:
  ...
  juce::String layerStateText(LooperLayer::State state,
                              int lengthSamples) const;
  juce::Colour layerStateColour(LooperLayer::State state) const;
  void drawLayerWaveform(juce::Graphics &g, juce::Rectangle<int> bounds,
                         const LooperLayer &layer, juce::Colour colour) const;
  void drawCaptureWindowWaveform(juce::Graphics &g, juce::Rectangle<int> bounds,
                                 int startSamplesAgo, int endSamplesAgo,
