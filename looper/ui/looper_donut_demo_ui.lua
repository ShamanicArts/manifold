...
local DONUT_DSP_PATH_CANDIDATES = {
    "/home/shamanic/dev/my-plugin/looper/dsp/looper_donut_demo_dsp.lua",
    "/home/shamanic/dev/my-plugin/build-dev/LooperPrimitives_artefacts/RelWithDebInfo/Standalone/looper_donut_demo_dsp.lua",
