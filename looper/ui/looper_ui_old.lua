-- looper_ui_old.lua
-- Original Looper plugin UI, built entirely with Lua Canvas widgets.
-- Mirrors the existing C++ LooperEditor layout and controls.
-- Kept for reference - the new looper_ui.lua is the minimal/clean version.

local W = require("looper_widgets_old")
